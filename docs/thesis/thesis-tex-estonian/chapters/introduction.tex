...
Käesoleva töö empiiriline ulatus tuleb lugeda kui \emph{prototüübi ja hindamismetoodika} dokumentatsiooni, mitte kui empiirilist hinnangut sellele, kuidas süsteem käitub laia kasutajaskonna käes. Kõik üldistused reaalsete kõnelejate käitumisele põhinevad kahel autorile lähedasel kõnelejal (autor, Kõneleja B) ning ühel treeningust eraldi hoitud kõnelejal (Kõneleja D, $N=145$ klippi); kavandatud kuni 10 osalejaga kasutajatesti piisavat lõppandmestikku selle töö raames ei moodustatud (vt §\ref{sec:user-test-results}). Töö ei käsitle täielikku STT/TTS-ahelat ning hindamine piirdub ühe äratusfraasiga.
