...
\newcommand{\thesisTitleEng}{Kratt: Estonian Wake Word Detection for Smart Home Microcontrollers} % variable with thesis title
\newcommand{\thesisTitleEst}{Kratt: eestikeelne äratussõnatuvastus nutikodu mikrokontrolleritele} % Title in Estonian
