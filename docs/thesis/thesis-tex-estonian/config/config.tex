...
\newcommand{\thesisTitleEng}{Kratt: Development and Evaluation of an Estonian Wake Word Detection Prototype for Smart Home Microcontrollers} % variable with thesis title
\newcommand{\thesisTitleEst}{Kratt: eestikeelse äratussõnatuvastuse prototüübi arendamine ja hindamine nutikodu mikrokontrolleritel} % Title in Estonian

% Choose your thesis
\newcommand{\thesisType}{Bachelor's Thesis}

% Thesis author
\newcommand{\authorName}{Mattias Linholm}
\newcommand{\studentcode}{233408IAIB}
...
% Main supervisor
\newcommand{\supervisorName}{Tanel Alumäe}
...
% PDF Metadata
\newcommand{\version}{0.2 version}
\newcommand{\keywords}{äratussõna, wake word, ESP32-S3, ESPHome, microWakeWord, eesti keel, nutikodu}
